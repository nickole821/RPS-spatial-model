...
dir.create("./output/data/stochastic/regular-neighborhood/prob_death")
...
for (i in 1:n_sim) {
  ...
  result <- simulation_prob_death(position_matrix, payoff_matrix, num_generations = 200,
                                  strategy = FALSE, divide = FALSE)
  
  pasta_resultados <- file.path("./output/data/stochastic/regular-neighborhood/prob_death",
                                paste0("sim_", i))
