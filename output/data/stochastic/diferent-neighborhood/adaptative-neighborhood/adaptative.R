source("output/data/stochastic/neighbors/adaptative/function-adaptative-neighborhood.R")
...
dir.create("output/data/stochastic/neighbors/adaptative/p0/")
...
for (i in 1:n_sim) {
  ...
  pasta_resultados <- file.path("output/data/stochastic/neighbors/adaptative/p0/",
                                paste0("sim_", i))
