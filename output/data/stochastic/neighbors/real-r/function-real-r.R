simulation_real_r <- function(position_matrix, payoff_matrix, num_generations, prob_reproduce,
                       strategy, devide) {
  ...
  get_fitness_matrix <- function(position_matrix, devide) {
  ...
  for (generation in 1:num_generations) {
    ...
    fitness_matrix <- get_fitness_matrix(position_matrix, devide)
